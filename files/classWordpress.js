...
(function() {
  ...
  Wordpress = class Wordpress {
    constructor(w = {}) {
      ...
      this.getAIsummary = this.getAIsummary.bind(this);
    ...
    getAIsummary(creds_tid, msg_tid) {
      var apikey, auth, creds_obj, e, formRequest, model, msg, msg_obj, msg_payload, msgs, payload, pl, sysmsg, sysmsg_payload, txt, txt_obj, url;
